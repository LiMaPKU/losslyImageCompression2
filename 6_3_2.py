...
# minLoss= 13.988 MSEL= 377.226 NLPL= 13.988 EL= 0.000 MS_SSIM= 0.899
# 导入信息熵损失
...
class EncodeNet(nn.Module):
    def __init__(self):
        ...
        self.conv_channels_up = nn.Conv2d(1, 100, 1)

        self.conv_down_256_16 = nn.Conv2d(100, 100, 16, 16)
        self.conv_down_128_16 = nn.Conv2d(100, 100, 8, 8)
        self.conv_down_64_16 = nn.Conv2d(100, 100, 4, 4)
        self.conv_down_32_16 = nn.Conv2d(100, 100, 2, 2)

        self.gdn_down_256_16 = pytorch_gdn.GDN(100)
        self.gdn_down_128_16 = pytorch_gdn.GDN(100)
        self.gdn_down_64_16 = pytorch_gdn.GDN(100)
        self.gdn_down_32_16 = pytorch_gdn.GDN(100)

        self.conv_down_256_128 = nn.Conv2d(100, 100, 2, 2)
        self.conv_down_128_64 = nn.Conv2d(100, 100, 2, 2)
        self.conv_down_64_32 = nn.Conv2d(100, 100, 2, 2)
        self.conv_down_32_16 = nn.Conv2d(100, 100, 2, 2)

        self.gdn_down_256_128 = pytorch_gdn.GDN(100)
        self.gdn_down_128_64 = pytorch_gdn.GDN(100)
        self.gdn_down_64_32 = pytorch_gdn.GDN(100)
        self.gdn_down_32_16 = pytorch_gdn.GDN(100)
...
class DecodeNet(nn.Module):
    def __init__(self):
        ...
        self.tconv_channels_down = nn.ConvTranspose2d(100, 1, 1)

        self.tconv_up_16_256 = nn.ConvTranspose2d(100, 100, 16, 16)
        self.tconv_up_16_128 = nn.ConvTranspose2d(100, 100, 8, 8)
        self.tconv_up_16_64 = nn.ConvTranspose2d(100, 100, 4, 4)
        self.tconv_up_16_32 = nn.ConvTranspose2d(100, 100, 2, 2)

        self.igdn_up_16_256 = pytorch_gdn.GDN(100, True)
        self.igdn_up_16_128 = pytorch_gdn.GDN(100, True)
        self.igdn_up_16_64 = pytorch_gdn.GDN(100, True)
        self.igdn_up_16_32 = pytorch_gdn.GDN(100, True)

        self.tconv_up_32_64 = nn.ConvTranspose2d(100, 100, 2, 2)
        self.tconv_up_64_128 = nn.ConvTranspose2d(100, 100, 2, 2)
        self.tconv_up_128_256 = nn.ConvTranspose2d(100, 100, 2, 2)

        self.igdn_up_32_64 = pytorch_gdn.GDN(100, True)
        self.igdn_up_64_128 = pytorch_gdn.GDN(100, True)
        self.igdn_up_128_256 = pytorch_gdn.GDN(100, True)
