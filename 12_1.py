...
class EncodeNet(nn.Module):
    def __init__(self):
        ...
        self.conv1_0 = nn.Conv2d(64, 64, 1, 1)
        self.conv1_1 = nn.Conv2d(64, 64, 1, 1)
        self.conv1_2 = nn.Conv2d(64, 64, 1, 1)
        self.conv1_3 = nn.Conv2d(64, 64, 1, 1)
        self.conv1_4 = nn.Conv2d(64, 64, 1, 1)
        self.conv1_5 = nn.Conv2d(64, 64, 1, 1)
        self.conv1_6 = nn.Conv2d(64, 64, 1, 1)
        self.conv1_7 = nn.Conv2d(64, 64, 1, 1)
    ...
    def forward(self, x):
        ...
        x2 = F.leaky_relu(self.conv1_0(x1))
        x2 = self.gdn_down_256_128(F.leaky_relu(self.conv_down_256_128(x2)))
        x2 = F.leaky_relu(self.conv1_1(x2))

        x3 = F.leaky_relu(self.conv1_2(x2))
        x3 = self.gdn_down_128_64(F.leaky_relu(self.conv_down_128_64(x3)))
        x3 = F.leaky_relu(self.conv1_3(x3))

        x4 = F.leaky_relu(self.conv1_4(x3))
        x4 = self.gdn_down_64_32(F.leaky_relu(self.conv_down_64_32(x4)))
        x4 = F.leaky_relu(self.conv1_5(x4))

        x5 = F.leaky_relu(self.conv1_6(x4))
        x5 = self.gdn_down_32_16(F.leaky_relu(self.conv_down_32_16(x5)))
        x5 = F.leaky_relu(self.conv1_7(x5))
...
class DecodeNet(nn.Module):
    def __init__(self):
        ...
        self.tconv1_0 = nn.ConvTranspose2d(64, 64, 1, 1)
        self.tconv1_1 = nn.ConvTranspose2d(64, 64, 1, 1)
        self.tconv1_2 = nn.ConvTranspose2d(64, 64, 1, 1)
        self.tconv1_3 = nn.ConvTranspose2d(64, 64, 1, 1)
        self.tconv1_4 = nn.ConvTranspose2d(64, 64, 1, 1)
        self.tconv1_5 = nn.ConvTranspose2d(64, 64, 1, 1)
        self.tconv1_6 = nn.ConvTranspose2d(64, 64, 1, 1)
        self.tconv1_7 = nn.ConvTranspose2d(64, 64, 1, 1)
    ...
    def forward(self, x5):
        x5 = x5 / 255
        x4 = self.tconv1_0(x5)
        x4 = F.leaky_relu(self.tconv_up_16_32(self.igdn_up_16_32(x4)))
        x4 = self.tconv1_1(x4)

        x3 = self.tconv1_2(x4)
        x3 = F.leaky_relu(self.tconv_up_32_64(self.igdn_up_32_64(x3)))
        x3 = self.tconv1_3(x3)

        x2 = self.tconv1_4(x3)
        x2 = F.leaky_relu(self.tconv_up_64_128(self.igdn_up_64_128(x2)))
        x2 = self.tconv1_5(x2)

        x1 = self.tconv1_6(x2)
        x1 = F.leaky_relu(self.tconv_up_128_256(self.igdn_up_128_256(x1)))
        x1 = self.tconv1_7(x1)
