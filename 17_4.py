...
class EncodeNet(nn.Module):
    def __init__(self):
        ...
        self.conv_channels_down_256_128 = nn.Conv2d(256, 128, 1)
        ...
        self.conv_channels_down_32_16 = nn.Conv2d(32, 16, 1)
    ...
    def forward(self, x):
        ...
        x2 = F.leaky_relu(self.conv_channels_down_256_128(x2))

        x3 = self.gdn_down_128_64(F.leaky_relu(self.conv_down_128_64(x2)))
        x3 = F.leaky_relu(self.conv_channels_down_128_64(x3))

        x4 = self.gdn_down_64_32(F.leaky_relu(self.conv_down_64_32(x3)))
        x4 = F.leaky_relu(self.conv_channels_down_64_32(x4))

        x5 = self.gdn_down_32_16(F.leaky_relu(self.conv_down_32_16(x4)))
        x5 = F.leaky_relu(self.conv_channels_down_32_16(x5))
...
class DecodeNet(nn.Module):
    def __init__(self):
        ...
        self.tconv_channels_up_16_32 = nn.ConvTranspose2d(16, 32, 1)
        ...
        self.tconv_channels_up_64_128 = nn.ConvTranspose2d(64, 128, 1)
        self.tconv_up_64_128 = nn.ConvTranspose2d(128, 128, 2, 2)

        self.tconv_channels_up_128_256 = nn.ConvTranspose2d(128, 256, 1)
    ...
    def forward(self, x5):
        x5 = F.leaky_relu(self.tconv_channels_up_16_32(x5))
        x4 = F.leaky_relu(self.tconv_up_16_32(self.igdn_up_16_32(x5)))

        x4 = F.leaky_relu(self.tconv_channels_up_32_64(x4))
        x3 = F.leaky_relu(self.tconv_up_32_64(self.igdn_up_32_64(x4)))

        x3 = F.leaky_relu(self.tconv_channels_up_64_128(x3))
        x2 = F.leaky_relu(self.tconv_up_64_128(self.igdn_up_64_128(x3)))

        x2 = F.leaky_relu(self.tconv_channels_up_128_256(x2))
