...
class EncodeNet(nn.Module):
    def __init__(self):
        ...
        self.conv_down_64_32 = nn.Conv2d(64, 48, 2, 2)

        self.conv_down_32_16 = nn.Conv2d(48, 32, 2, 2)
...
class DecodeNet(nn.Module):
    def __init__(self):
        ...
        self.tconv_up_16_32 = nn.ConvTranspose2d(32, 48, 2, 2)

        self.tconv_up_32_64 = nn.ConvTranspose2d(48, 64, 2, 2)
