...
class DecodeNet(nn.Module):
    def __init__(self):
        ...
        self.tconv_up_16_32 = nn.ConvTranspose2d(48, 48, 2, 2)
        ...
        self.igdn_up_16_32 = pytorch_gdn.GDN(48, True)
...
for i in range(int(sys.argv[4])):
    ...
    print(qEncData.max().item(),qEncData.min().item(),'minLoss=','%.3f'%minLoss.item(),'MSEL=','%.3f'%minLossMSEL.item(),'MS_SSIM=','%.3f'%minLossMS_SSIM.item())
