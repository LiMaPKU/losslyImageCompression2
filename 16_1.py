...
class EncodeNet(nn.Module):
    def __init__(self):
        ...
        self.conv_channels_up1 = nn.Conv2d(1, 32, 5, padding=2)
        self.conv_channels_up2 = nn.Conv2d(1, 32, 1)
    ...
    def forward(self, x):
        ...
        x1 = F.leaky_relu(self.conv_channels_up1(x)) + F.leaky_relu(self.conv_channels_up2(x))
...
class DecodeNet(nn.Module):
    def __init__(self):
        ...
        self.tconv_channels_down1 = nn.ConvTranspose2d(32, 1, 5, padding=2)
        self.tconv_channels_down2 = nn.ConvTranspose2d(32, 1, 1)
    ...
    def forward(self, x5):
        ...
        x = F.leaky_relu(self.tconv_channels_down1(x1)) + F.leaky_relu(self.tconv_channels_down2(x1))
