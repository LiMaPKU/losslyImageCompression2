...
class EncodeNet(nn.Module):
    def __init__(self):
        ...
        self.conv3_128 = nn.Conv2d(64, 64, 3, 1, padding=1)
        self.conv_down_128_64 = nn.Conv2d(64, 64, 2, 2)
        self.conv3_64 = nn.Conv2d(64, 64, 3, 1, padding=1)
        self.conv_down_64_32 = nn.Conv2d(64, 64, 2, 2)
        self.conv3_32 = nn.Conv2d(64, 64, 3, 1, padding=1)
        self.conv_down_32_16 = nn.Conv2d(64, 64, 2, 2)
        self.conv3_16 = nn.Conv2d(64, 64, 3, 1, padding=1)
