...
class EncodeNet(nn.Module):
    ...
    def forward(self, x):
        ...
        y1 = self.gdn_down_256_16(F.leaky_relu(self.conv_down_256_16(self.k1_1 * x1)))

        x2 = self.gdn_down_256_128(F.leaky_relu(self.conv_down_256_128(self.k1_2 * x1)))
        y2 = self.gdn_down_128_16(F.leaky_relu(self.conv_down_128_16(self.k2_1 * x2)))

        x3 = self.gdn_down_128_64(F.leaky_relu(self.conv_down_128_64(self.k2_2 * x2)))
        y3 = self.gdn_down_64_16(F.leaky_relu(self.conv_down_64_16(self.k3_1 * x3)))

        x4 = self.gdn_down_64_32(F.leaky_relu(self.conv_down_64_32(self.k3_2 * x3)))
        y4 = self.gdn_down_32_16(F.leaky_relu(self.conv_down_32_16(self.k4_1 * x4)))

        return self.k1_3 * y1 + self.k2_3 * y2 + self.k3_3 * y3 + self.k4_3 * y4
...
class DecodeNet(nn.Module):
    ...
    def forward(self, x):
        x4 = F.leaky_relu(self.tconv_up_16_32(self.igdn_up_16_32(self.k4_3 * x)))

        x3 = F.leaky_relu(self.tconv_up_16_64(self.igdn_up_16_64(self.k3_3 * x)))
        x3_ = F.leaky_relu(self.tconv_up_32_64(self.igdn_up_32_64(x4)))
        x3 = self.k3_1 * x3 + self.k3_2 * x3_

        x2 = F.leaky_relu(self.tconv_up_16_128(self.igdn_up_16_128(self.k2_3 * x)))
        x2_ = F.leaky_relu(self.tconv_up_64_128(self.igdn_up_64_128(x3)))
        x2 = self.k2_1 * x2 + self.k2_2 * x2_

        x1 = F.leaky_relu(self.tconv_up_16_256(self.igdn_up_16_256(self.k1_3 * x)))
        x1_ = F.leaky_relu(self.tconv_up_128_256(self.igdn_up_128_256(x2)))
        x1 = self.k1_1 * x1 + self.k1_2 * x1_
