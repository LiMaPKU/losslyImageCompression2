...
class DecodeNet(nn.Module):
    def __init__(self):
        ...
        self.tconv_up_8_256 = nn.ConvTranspose2d(128, 128, 32, 32)
        self.tconv_up_8_128 = nn.ConvTranspose2d(128, 128, 16, 16)
        self.tconv_up_8_64 = nn.ConvTranspose2d(128, 128, 8, 8)
        self.tconv_up_8_32 = nn.ConvTranspose2d(128, 128, 4, 4)
        self.tconv_up_8_16 = nn.ConvTranspose2d(128, 128, 2, 2)

        self.igdn_up_8_256 = pytorch_gdn.GDN(128, True)
        self.igdn_up_8_128 = pytorch_gdn.GDN(128, True)
        self.igdn_up_8_64 = pytorch_gdn.GDN(128, True)
        self.igdn_up_8_32 = pytorch_gdn.GDN(128, True)
        self.igdn_up_8_16 = pytorch_gdn.GDN(128, True)
