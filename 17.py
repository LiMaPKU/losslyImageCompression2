...
class EncodeNet(nn.Module):
    def __init__(self):
        ...
        self.conv_down_16_8 = nn.Conv2d(32, 32, 2, 2)
        ...
        self.gdn_down_16_8 = pytorch_gdn.GDN(32)
...
class DecodeNet(nn.Module):
    def __init__(self):
        ...
        self.tconv_up_8_16 = nn.ConvTranspose2d(32, 32, 2, 2)
        ...
        self.igdn_up_8_16 = pytorch_gdn.GDN(32, True)
