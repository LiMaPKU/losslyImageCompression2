...
class EncodeNet(nn.Module):
    def __init__(self):
        ...
        self.conv_channels_down_128_96 = nn.Conv2d(128, 96, 1)
        self.conv_channels_down_96_64 = nn.Conv2d(96, 64, 1)
    ...
    def forward(self, x):
        ...
        y = y1 + y2 + y3 + y4
        y = F.leaky_relu(self.conv_channels_down_128_96(y))
        y = F.leaky_relu(self.conv_channels_down_96_64(y))
        return y
...
class DecodeNet(nn.Module):
    def __init__(self):
        ...
        self.tconv_channels_up_64_96 = nn.ConvTranspose2d(64, 96, 1)
        self.tconv_channels_up_96_128 = nn.ConvTranspose2d(96, 128, 1)

    def forward(self, x):
        x = F.leaky_relu(self.tconv_channels_up_64_96(x))
        x = F.leaky_relu(self.tconv_channels_up_96_128(x))
