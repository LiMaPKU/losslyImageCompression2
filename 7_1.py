...
class DecodeNet(nn.Module):
    def __init__(self):
        ...
        self.tconv_channels_down1 = nn.ConvTranspose2d(32, 1, 1)
        self.tconv_channels_down2 = nn.ConvTranspose2d(32, 1, 2, 2)
        self.tconv_channels_down3 = nn.ConvTranspose2d(32, 1, 4, 4)
        self.tconv_channels_down4 = nn.ConvTranspose2d(32, 1, 8, 8)

        self.tconv_up_16_256 = nn.ConvTranspose2d(32, 32, 16, 16)
        self.tconv_up_16_128 = nn.ConvTranspose2d(32, 32, 8, 8)
        self.tconv_up_16_64 = nn.ConvTranspose2d(32, 32, 4, 4)
        self.tconv_up_16_32 = nn.ConvTranspose2d(32, 32, 2, 2)

        self.igdn_up_16_256 = pytorch_gdn.GDN(32, True)
        self.igdn_up_16_128 = pytorch_gdn.GDN(32, True)
        self.igdn_up_16_64 = pytorch_gdn.GDN(32, True)
